 ...
 * @version 1.0
 */
public class RowprintCommand extends Command {

    /**
     * Instantiates a new insert command.
     */
    public RowprintCommand() {
        super("rowprint", "rowprint <rownumber>", 1);
    }
    ...
    public void execute(final String command, final BoardGame game) {
        try {
            Terminal.printLine(game.rowToString(Integer.parseInt(commandToParametersArray(command)[0])));
