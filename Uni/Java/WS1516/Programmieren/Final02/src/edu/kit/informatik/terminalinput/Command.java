...
public abstract class Command {
     ...
     */
    protected boolean correctCommand(final String str) {
     ...
     *            the boardGame
     */
    public abstract void execute(String command, BoardGame boardGame);
    ...
    /**
     * returns the parameter count needed for correct syntax
     * 
